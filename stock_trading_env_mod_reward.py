...
class StockTradingEnv(gym.Env):
    ...
    def __init__(
        ...
        self.baseline_daily_returns = baseline_daily_returns
        # initalize state
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            # print("day: {} begin_total_asset: {} cash bal: {}".format(self.day, begin_total_asset, self.state[0]))
            ...
            end_total_asset_by_index = begin_total_asset*(1 + self.baseline_daily_returns[self.day])
            self.asset_memory.append(end_total_asset)
            self.date_memory.append(self._get_date())
            # self.reward = end_total_asset - begin_total_asset
            self.reward = (
                1000*((end_total_asset-begin_total_asset)/begin_total_asset) 
                # -100*(1 + self.baseline_daily_returns[self.day])
            )
            ...
            if end_total_asset > end_total_asset_by_index:
                self.reward += 100
            else:
                self.reward -= 100
            # print(f"day: {self.day} begin_total_asset: {begin_total_asset} end_total_asset: {end_total_asset} end_total_index: {end_total_asset_by_index} r: {self.reward} pr: {self.prev_reward}")
